...
import com.emuji.emuji.databinding.ActivityUserPlaylistsBinding
import kotlinx.coroutines.launch

/**
 * Activity displaying user's emoji-based playlists from Spotify.
 */
class UserPlaylistsActivity : AppCompatActivity() {
    private lateinit var binding: ActivityUserPlaylistsBinding
    private val spotifyUtil = SpotifyUtil()
    private lateinit var adapter: PlaylistAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityUserPlaylistsBinding.inflate(layoutInflater)
    ...
    private fun loadPlaylists() {
        ...
        lifecycleScope.launch {
            try {
                val playlists = spotifyUtil.getUserPlaylists(token)
    ...
    companion object {
        private const val TAG = "UserPlaylistsActivity"
    }
}
